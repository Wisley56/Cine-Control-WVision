  ...
  return (
    <>
      <form
        ...
        className="flex flex-col gap-5 max-w-lg mx-auto p-4 sm:p-6 border border-[var(--border-color)] rounded-lg shadow-md bg-[var(--card-background)]"
      >
        <h2 className="text-xl sm:text-2xl font-bold text-[var(--highlight-text)] mb-4 sm:mb-6 text-center">Cadastrar Nova Sessão</h2>
