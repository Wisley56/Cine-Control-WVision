...
export default function FilmeForm() {
  ...
  return (
    ...
    >
      ...
      <div>
        <label htmlFor="titulo" className="block text-sm font-medium text-[var(--muted-text)] mb-1">
          Título:
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="descricao" className="block text-sm font-medium text-[var(--muted-text)] mb-1">
          Descrição:
        </label>
        <textarea
          id="descricao"
      ...
      <div>
        <label htmlFor="genero" className="block text-sm font-medium text-[var(--muted-text)] mb-1">
          Gênero:
        </label>
        <select
          id="genero"
      ...
      <div>
        <label htmlFor="classificacao" className="block text-sm font-medium text-[var(--muted-text)] mb-1">
      ...
      <div>
        <label htmlFor="duracao" className="block text-sm font-medium text-[var(--muted-text)] mb-1">
          Duração (minutos):
        </label>
        <input
          type="number"
      ...
      <div>
        <label htmlFor="dataEstreia" className="block text-sm font-medium text-[var(--muted-text)] mb-1">
          Data de Estreia:
        </label>
        <input
          type="date"
      ...
      <div>
        <label htmlFor="imagemUrl" className="block text-sm font-medium text-[var(--muted-text)] mb-1">
          URL da Imagem:
        </label>
        <input
          type="url"
